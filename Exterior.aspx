<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Exterior.aspx.cs" Inherits="Exterior" %>
...
<head>
    ...
    <title>Èmeraude Maison Exterior</title>
  ...
  <div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
      <div class="item active">
        <img class="img-responsive center-block" src="img/ext1.jpg" alt="View" width="970" height="546">
      </div>

      <div class="item">
        <img class="img-responsive center-block" src="img/ext2.jpg" alt="Aerial" width="970" height="546">
      </div>
    
      <div class="item">
        <img class="img-responsive center-block" src="img/ext3.jpg" alt="Side" width="970" height="546">
      </div>

      <div class="item">
        <img class="img-responsive center-block" src="img/ext4.jpg" alt="Front" width="970" height="546">
      </div>
    </div>
      ...
      <span class="sr-only">Next</span>
        ...
        <div class="header-content">
            <div class="header-content-inner">
                <h2 class="text-center"><span class="newStyle1">Emeraude Maison Exterior</span></h2>
                <hr>
                <p class="text-center"> See the wonderful views of the city</p>
