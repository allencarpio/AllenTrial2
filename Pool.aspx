...
<head>
    ...
    <title> Èmeraude Maison Pool </title>
    <meta charset="utf-8">
        ...
        <div id="myCarousel" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner" role="listbox">
                <div class="item active">
                    <img class="img-responsive center-block" src="Img/Pool/1.jpg" alt="1">
                    <div class="carousel-caption">
                        <h4>Midnight Relaxation Pool</h4>
                        
                    </div>
                </div>

                <div class="item">
                    <a href="#superior"><img class="img-responsive center-block" src="Img/Pool/2.jpg" alt="2"></a>
                    <div class="carousel-caption">
                        <h4>Top Floor Infinity Pool</h4>
                        
                    </div>
                </div>

                <div class="item">
                    <a href="#deluxe"><img class="img-responsive center-block" src="Img/Pool/3.jpg" alt="3"></a>
                    <div class="carousel-caption">
                        <h4>Olympian Black Pool</h4>
                        
                    </div>
                </div>

                <div class="item">
                    <a href="#captain"><img class="img-responsive center-block" src="Img/Pool/4.jpg" alt="4"></a>
                    <div class="carousel-caption">
                        <h4>Deluxe Jacuzzi</h4>
